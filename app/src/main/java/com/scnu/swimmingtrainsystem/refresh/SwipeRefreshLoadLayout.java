package com.scnu.swimmingtrainsystem.refresh;
...
public class SwipeRefreshLoadLayout extends ViewGroup {
    //我在这里设置了上拉距离触发事件需要的距离
    private final float DISTANCE_LOAD = 210;
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (canChildScrollUp()) {
                    ...
                    y1 = ev.getY();
                   // System.out.println(ev.getY()+"噢噢噢噢噢噢噢噢噢噢噢噢噢");
                } else {
            ...
            case MotionEvent.ACTION_UP:
               /* if (canChildScrollUp()) {
                    ...
                    System.out.println(ev.getY()+"斤斤计较斤斤计较斤斤计较斤斤计较斤斤计较");
                }*/
...
//                        //int[] visibleItems = lLManager.findLastVisibleItemPositions(null);
//                        int visibleItem = lLManager.findLastVisibleItemPosition();
//                       /* switch ()
//                        /////是两个还是三个
//                        int lastitem=0;
//                        switch (recycleItems){
...
//                                break;
//                            case 3:
//                                lastitem = Math.max(Math.max(visibleItems[0], visibleItems[1]), visibleItems[2]);
//                                break;
//                            case 4:
//                                lastitem = Math.max(Math.max(Math.max(visibleItems[0], visibleItems[1]), visibleItems[2]),visibleItems[3]);
//                                break;
//                        }*/
//
//
//                        if(visibleItem ==recycleItems)
//                        {
//                            if((y1-y2)>DISTANCE_LOAD) {
//                                if (mCanLoadMore) {
//                                    mCanLoadMore = false;
//                                    System.out.println(lLManager.findLastVisibleItemPosition()+"sasasadsfasgegreg");
//                                    mLoadMoreListener.loadMore();/////////////////////////////////////////////////
//                                }
//                            }
//                        }
...
//                    break;
    ...
    public void setRecycleItems(int recycleItems){
